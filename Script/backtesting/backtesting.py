...
def backtesting(df, investment, fee_per_transaction):
    ...
    # Optional: If you want to reset the index of the DataFrame    
    ...
    transactions = df.loc[(df['Signals'] == 1) | (df['Signals'] == 2)]
    ...
    df.to_csv('python_crypto_trading_bot/Results/11_2_backtesting_strategy1.csv', sep=',', index=False, encoding='utf-8')
    transactions.to_csv('python_crypto_trading_bot/Results/11_3_backtesting_strategy1_transactions.csv', sep=',', index=False, encoding='utf-8')
